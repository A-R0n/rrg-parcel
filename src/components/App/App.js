...
export default function App() {
  ...
  const [didUserSelectASuggestedRoute, setDidUserSelectASuggestedRoute] = React.useState(false);
  const [isLessThanSignShowing, setIsLessThanSignShowing] = React.useState(false);
  const [shouldShowDirections, setShouldShowDirections] = React.useState(false);
  const [shouldShowDirectionsButton, setShouldShowDirectionsButton] = React.useState(false);
  const [shouldShowSmallRoutePanoImg, setShouldShowPanoSmallRoutePanoImg] = React.useState(false);
  const [shouldShowBigRouteImg, setShouldShowBigRouteImg] = React.useState(false);
  ...
  const [shouldShowRouteIsDryInRain, setShouldShowRouteIsDryInRain] = React.useState(false)
    ...
    <main className="App">
        ...
        <div className="header-search">
          <div className="header-input-search" onClick={() => shrinkHeader()}>
            <SearchInputBox
              ...
              setShouldShowPanoSmallRoutePanoImg={
                setShouldShowPanoSmallRoutePanoImg
              }
            />
          </div>
      ...
      <div className="GoogleMap" ref={mapRefTrick}>
        ...
        {shouldShowDirectionsButton && (
          <DirectionsButton setShouldShowDirectionsCb={setShouldShowDirectionsCb} />
        )}
      </div>
      <footer>
